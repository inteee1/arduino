...
// v2.3 = 2023, 3, 20 = Ardunio 버전으로 수정
// Song Myoung Gyu
...
#include "main.h""*/
//----------------------------------------------------------------------------------------------
// hw pin map == 프로세서에 따라서 수정

#define MCU_RS_PIN  8 //arduino d8
#define MCU_EN_PIN  9 // arduino d9
...
#elif LCD_PD // 2023. 3. 20 추가
  #define LCD_PORT PORTD
/*#elif Arduino // 2023. 3. 20 추가
...
void lcd_str(unsigned char *buf) // 문자열 출력
{
...
void lcd_data(unsigned char *buf) // 문자열 출력
{
  // user string data display 
  while(*buf != '\n')
   {
